class TutorialsController < ApplicationController
  before_action :set_tutorial, only: [:show, :edit, :update, :destroy, :add_new_section]
  ...
  def add_new_section
    @section = @tutorial.sections.create(title: params[:title])
    @sections = @tutorial.sections
    respond_to do |format|
      format.js
    end
  ...
  private
    ...
    def tutorial_params
      params.require(:tutorial).permit(:title, :description, :user_id)
    end
end
